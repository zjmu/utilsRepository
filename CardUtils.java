...
/**
 * @ClassName: CardUtils
 * @Description TODO  用于身份证解析  性别年龄出生日期等
 * @Author: Mingzhi.Xu
...
public class CardUtils {
    ...
    public static Map<String, String> getBirAgeSex(String certificateNo) {
        ...
        if (flag && certificateNo.length() == 15) {
            ...
            sexCode = Integer.parseInt(certificateNo.substring(certificateNo.length() - 3, certificateNo.length())) % 2 == 0 ? "男" : "女";
            ...
            sexCode = Integer.parseInt(certificateNo.substring(certificateNo.length() - 4, certificateNo.length() - 1)) % 2 == 0 ? "男" : "女";
